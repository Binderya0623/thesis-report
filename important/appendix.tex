...
\textbf{Микрофронтенд} & Вэб хэрэглээний программын хэрэглэгчийн интерфэйсийг (UI) бие даасан, жижиг модулиудад хувааж хөгжүүлэх орчин үеийн архитектурын хэв маяг. \\ 
\textbf{Цул архитектур} & Программ хангамжийн хэрэглэгчийн интерфейс, өгөгдлийн сан, бизнесийн логик зэрэг бүх бүрэлдэхүүн хэсгүүд нэг кодын санд, нэгдмэл байдлаар хөгжүүлэгддэг уламжлалт загвар. \\ 
...
\textbf{Үндсэн хэрэглээний программ (App-shell)} & Микрофронтендүүдийг дотроо агуулж, шаардлагатай үед динамикаар дуудаж ажиллуулах үүрэгтэй, хэрэглэгчийн интерфэйсийн үндсэн чиглүүлэгч программ. \\ 
...
\textbf{JSF} & JavaServer Faces & Java хэл дээр суурилсан, серверийн талд хэрэглэгчийн интерфэйсийг угсарч хөтөч рүү илгээдэг вэб фреймворк. \\ 
\textbf{DOM} & Document Object Model & Вэб хуудсын бүтцийг мод хэлбэрээр дүрсэлж, программчлалын хэлээр хандах, өөрчлөлт оруулах боломжийг олгодог интерфейс. \\ 
...
\textbf{UI/UX} & User Interface / User Experience & Хэрэглэгчийн интерфейс (харагдах байдал) болон хэрэглэгчийн туршлага (ашиглахад хэр таатай, ойлгомжтой байх байдал). \\ 
...
\chapter{Микрофронтенд хуудсууд}
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{images/mf2.png}
...
public class DefenseSessionController {
    ...
    // Canonical DB stage names + фронтенд aliases
    ...
    // Map фронтенд aliases to DB-accepted values
