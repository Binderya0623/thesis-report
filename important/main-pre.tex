...
\end{huge} \\ \ \\ 
\doublespace
Миний бие Цэдэн-Ишийн Биндэрцэцэг нь "Холимог Микрофронтенд Архитектур: React ба JSF ашигласан кейс судалгаа" \ сэдэвтэй судалгааны ажлыг гүйцэтгэсэн болохыг зарлаж дараах зүйлсийг баталж байна:
\begin{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{images/tuluvluguu.png}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{images/review.png}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{images/tod.png}
\end{figure}
