...
\begin{itemize}
  ...
  \item \texttt{mauth\_current\_user}: \texttt{\{username, displayName,
    role\}} бүтэцтэй JSON. Энэ нь хэрэг- лэгчийн нэр, үүрэг зэргийг хадгалана.
\end{itemize}
...
JSF-ийн хуудасны дагуу cookie scope нарийн удирдлага шаарддаг тул энэ системд \texttt{localStorage} ашигласан бөгөөд үйлдвэрлэлийн
...
үүргийн мэдээлэл ирнэ; дараа нь \texttt{GET http://localhost:8086/api/users/by-email}
...
Бэкенд микросервисүүдийн хэрэгжүүлэлтэд Java~21 болон Spring Boot~3.2.x
...
\begin{itemize}
  ...
  \item \textbf{Порт:} Ажлын явцын интерфейс. Жишээ нь
...
\texttt{authorization-service} нь үүрэг болон эрхийн матрицийг удирдана.
...
reverse proxy хослуулан) бэкенд сервисүүд рүү HTTP хүсэлтийг
...
Фронтенд-аас ирсэн API хүсэлт бүр \texttt{Authorization: Bearer
\{jwt\}} header агуулдаг. Бэкенд-ийн сервис тус бүр энэ header-г
...
механизм бөгөөд Фронтенд (8080) ба Бэкенд сервисүүд (8081--8887)
